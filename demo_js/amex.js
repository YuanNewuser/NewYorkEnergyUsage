...
function ipFetch(nrgAmex) {
    ...
    lineurl = "https://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/nrg_bal_c?precision=1";
    lineurl += "&nrg_bal=" + variable;
    lineurl += "&unit=" + "KTOE";
    lineurl += "&geo=" + "EU27_2020";
    lineurl += "&siec=" + amexSiec;

    colurl = "https://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/nrg_bal_c?precision=1";
